  ...
  return (
    <div className="pt-14 min-h-screen bg-[#060609] relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full bg-cyan-500/[0.04] blur-[130px]" />
        <div className="absolute top-1/2 -translate-y-1/2 -left-60 w-[500px] h-[500px] rounded-full bg-violet-500/[0.04] blur-[120px]" />
        <div className="absolute bottom-0 right-1/3 w-[400px] h-[400px] rounded-full bg-cyan-400/[0.03] blur-[100px]" />
        {/* dot grid */}
        <div
      ...
      <div className="relative border-b border-white/[0.06] bg-gradient-to-r from-[#07070e]/95 via-[#08091a]/85 to-[#07070e]/95 backdrop-blur-sm">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-mono text-gray-500 border border-white/[0.07] rounded-md px-2.5 py-1.5 bg-white/[0.02] backdrop-blur-sm">
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[calc(100vh-112px)]">
          ...
          <aside className="w-56 shrink-0 border-r border-white/[0.05] py-5 pr-3 flex flex-col gap-1">
          ...
          {/* ── CENTER: Skill cards ───────────────────────────────────────── */}
          <div className="w-64 shrink-0 border-r border-white/[0.05] py-5 px-3 overflow-y-auto">
            {/* Section header */}
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : "bg-white/[0.02] border-white/[0.06] hover:bg-white/[0.04] hover:border-white/[0.10] hover:shadow-[0_0_12px_rgba(255,255,255,0.03)]"
                    )}
                  >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <ChevronRight className={cn(
                        ...
                        isSelected
                          ? isCyan ? "text-cyan-400 rotate-90" : "text-violet-400 rotate-90"
                          : "text-gray-700 group-hover:text-gray-500"
                      )} />
                    </div>

                    <p className={cn(
                      "text-[12px] font-semibold leading-snug mb-1.5 transition-colors duration-150",
                      isSelected ? "text-white" : "text-gray-300 group-hover:text-white"
                    )}>
                      {skill.name}
                    </p>

                    <p className="text-[10px] text-gray-600 leading-relaxed line-clamp-2 mb-2">
                      {skill.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {skill.tags.slice(0, 3).map((tag) => (
                        <span
                          key={tag}
                          className="text-[9px] font-mono text-gray-600 bg-white/[0.03] border border-white/[0.05] rounded px-1.5 py-0.5"
                        >
                          {tag}
                        </span>
                      ))}
                      {skill.tags.length > 3 && (
                        <span className="text-[9px] font-mono text-gray-700">+{skill.tags.length - 3}</span>
                      )}
                    </div>
                  </button>
                );
          ...
          <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
            {selectedSkill ? (
              <>
                ...
                <div className="border-b border-white/[0.05] px-6 py-4 flex items-start justify-between gap-4 shrink-0 bg-gradient-to-r from-white/[0.015] to-transparent">
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className={cn(
                        "inline-flex items-center gap-1 text-[9px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded border",
                        categoryAccent[selectedSkill.type]
                      )}>
                    ...
                    <h2 className={cn(
                      ...
                      selectedSkill.type === "detection"
                        ? "from-white via-white to-cyan-200"
                        : "from-white via-white to-violet-200"
                    )}>
                      {selectedSkill.name}
                    </h2>
                ...
                <div className="flex border-b border-white/[0.05] shrink-0 bg-[#040409]/60">
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === "prompt"
                        ? "text-cyan-300 border-cyan-500 bg-cyan-500/[0.06]"
                ...
                {/* Content area */}
                <div className="flex-1 overflow-auto bg-[#020207] relative">
                  {/* subtle grid */}
                  <div
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  <div className="w-14 h-14 mx-auto mb-3 rounded-2xl border border-white/[0.07] bg-gradient-to-br from-white/[0.04] to-transparent flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.05)]">
